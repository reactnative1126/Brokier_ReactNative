...
class Home extends React.Component {
    ...
    async searchResult(search) {
        ...
        await getSearch(search).then(searches => {
        ...
        return (
            <div className='home-wrapper'>
                <div className="mobile-home-header">
                    ...
                    <button className='mobile-tabs-button' onClick={() => this.setState({ tabs: !this.state.tabs })}>
                        {this.state.tabs ? 'List' : 'Map'}
                    </button>
                    {!isEmpty(this.state.search) && (
                        !isEmpty(this.state.searches) ? (
                ...
                <div className={this.state.tabs ? 'home-left-panel' : 'home-left-panel mobile-display-none'}>
                    {this.state.tabs && (
                        <div className='home-status-bar'>
                            <div className='home-view-buttons mobile-view-buttons'>
                            ...
                            <div className='home-status-buttons'>
                                ...
                                {!this.state.drawing ? (
                                    <button className='home-inactive-button mobile-drawing-button' onClick={() => {
                                        this.setState({ drawing: true, scrollwheel: false, polygon: true, coordinates: [], listings3: [] }, () => {
                                            this.handleGoogleMapApi(this.state.google);
                                        })
                                    }}>
                                        ...
                                        <Fragment>
                                            <button className='home-apply-button mobile-apply-button' onClick={() => this.onApply()}>
                                                <i className='fas fa-check f-s-12' style={{ color: '#45AB62' }}></i>
                                                <span className='home-apply-text'>Apply</span>
                                            </button>
                                            <button className='home-cancel-button mobile-cancel-button' onClick={() => {
                    ...
                    <div className='home-left-panel-map'>
                        <GoogleMapReact
                            ...
                            onClick={() => {
                                !isEmpty(this.state.details) && this.setState({ details: [], scrollwheel: true })
                            }}
                            ...
                            {!this.state.drawing ? (
                                ...
                                this.state.listings3.map((item, key) => (
                                    item[0].count > 1 ?
                                        ...
                                        //     window.details = item;
                                        //     this.setState({ details: item, scrollwheel: false }, () => {
                                        //         console.log('-----------2', this.state.details)
                                        //     });
                                        // }}
                                        />
                                ))}
                ...
                <div className={!this.state.tabs ? 'home-right-panel' : 'home-right-panel mobile-display-none'}>
                    {!this.state.tabs && (
                        <div className='home-status-bar'>
                            <div className='home-status-buttons'>
                                <button className='home-inactive-button' onClick={() => console.log('OK')}>
                                    <i className='fas fa-angle-down f-s-12' style={{ paddingRight: 5 }}></i>
                                    <span>Sort</span>
                                    <i className='fas fa-bars f-s-12' style={{ paddingLeft: 5 }}></i>
                                </button>
                                <button className='home-inactive-button' onClick={() => this.setState({ filter: true })}>
                                    <i className='fas fa-angle-down f-s-12' style={{ paddingRight: 5 }}></i>
                                    <span>Filters</span>
